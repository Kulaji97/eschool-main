...
namespace ESCHOOLING.Web.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public StudentController(ILogger<TeacherController> logger, IApplicationUserService applicatioUserService, IConfiguration config, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
        ...
        [HttpGet]
        //[Route("ChatWithDoctor")]
        public IActionResult ChatWithDoctor()
        {
            return View();
        }
    }
